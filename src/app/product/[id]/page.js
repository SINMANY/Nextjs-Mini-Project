...
export default async function ProductDetails({ params }) {
    ...
    return (
        ...
        <div class="flex flex-col items-center bg-gray-800 border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 m-8">
            {product.images && (
